...
// TestToDoServiceServerRead - read test
...
// TestToDoServiceServerUpdate - update test
func TestToDoServiceServerUpdate(t *testing.T) {
	ctx := context.Background()
	db, mock, err := sqlmock.New()
	if err != nil {
		t.Fatalf("an error '%s' was not expected when opening a stub database connection", err)
...
// TestToDoServiceServerDelete - delete test
...
// TestToDoServiceServerReadAll - read all test
